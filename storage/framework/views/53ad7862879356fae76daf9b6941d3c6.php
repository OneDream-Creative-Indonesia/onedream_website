...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','href' => 'mailto:hello@onedream.id','icon' => 'heroicon-m-chat-bubble-left-right','icon-alias' => 'panels::widgets.filament-info.open-documentation-button','rel' => 'noopener noreferrer','target' => '_blank']); ?>
                    <p class="text-xs ">hello@onedream.id</p>
