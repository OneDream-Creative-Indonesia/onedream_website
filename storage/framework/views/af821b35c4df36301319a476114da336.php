            ...
            <div class="row">
                <div class="col-xl-5 col-lg-6">
                    <div class="slider-content mt-15">
                        ...
                        <a href="<?php echo e(url('/')); ?>" class="btn wow slideInLeft btn-home" data-wow-delay="0.6s">Start now</a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="single-features mb-30">
                    ...
                    <div class="features-content">
                        ...
                        <a href="<?php echo e(url('/service/video')); ?>">More About</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="single-features active mb-30">
                    ...
                    <div class="features-content">
                        ...
                        <a href="<?php echo e(url('/service/desain')); ?>">More About</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="single-features mb-30">
                    ...
                    <div class="features-content">
                        ...
                        <a href="<?php echo e(url('/service/foto')); ?>">More About</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row justify-content-between mb-95">
            ...
            <div class="col-xl-6 col-md-6">
                <div class="services-title-content">
                    ...
                    <a href="<?php echo e(url('/service')); ?>">More Service <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
        <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\onedream_website\resources\views/home.blade.php ENDPATH**/ ?>